...
| Platform | Download |
|----------|----------|
| **macOS** | [GitSquid_2.4.1_aarch64.app.tar.gz](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.4.1/GitSquid_2.4.1_aarch64.app.tar.gz) |
| **Windows** | [GitSquid_2.4.1_x64-setup.exe](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.4.1/GitSquid_2.4.1_x64-setup.exe) |
| **Linux** | [GitSquid_2.4.1_amd64.AppImage](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.4.1/GitSquid_2.4.1_amd64.AppImage) |
...
2. Extract it (double-click or `tar -xzf GitSquid_2.4.1_aarch64.app.tar.gz`) and move GitSquid.app to your Applications folder
