...
| Platform | Download |
|----------|----------|
| **macOS** | [GitSquid_2.3.0_aarch64.app.tar.gz](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.3.0/GitSquid_2.3.0_aarch64.app.tar.gz) |
| **Windows** | [GitSquid_2.3.0_x64-setup.exe](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.3.0/GitSquid_2.3.0_x64-setup.exe) |
| **Linux** | [GitSquid_2.3.0_amd64.AppImage](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.3.0/GitSquid_2.3.0_amd64.AppImage) |
...
2. Extract it (double-click or `tar -xzf GitSquid_2.3.0_aarch64.app.tar.gz`) and move GitSquid.app to your Applications folder
