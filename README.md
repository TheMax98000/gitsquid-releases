...
| Platform | Download |
|----------|----------|
| **macOS** (Apple Silicon) | [GitSquid-1.5.0-mac.dmg](https://github.com/TheMax98000/gitsquid-releases/releases/download/v1.5.0/GitSquid-1.5.0-mac.dmg) |
| **Windows** | [GitSquid-1.5.0-win-setup.exe](https://github.com/TheMax98000/gitsquid-releases/releases/download/v1.5.0/GitSquid-1.5.0-win-setup.exe) |
| **Linux** | [GitSquid-1.5.0-linux.AppImage](https://github.com/TheMax98000/gitsquid-releases/releases/download/v1.5.0/GitSquid-1.5.0-linux.AppImage) |
