...
| Platform | Download |
|----------|----------|
| **macOS** (Apple Silicon) | [GitSquid-1.7.3-mac.dmg](https://github.com/TheMax98000/gitsquid-releases/releases/download/v1.7.3/GitSquid-1.7.3-mac.dmg) |
| **Windows** | [GitSquid-1.7.3-win-setup.exe](https://github.com/TheMax98000/gitsquid-releases/releases/download/v1.7.3/GitSquid-1.7.3-win-setup.exe) |
| **Linux** | [GitSquid-1.7.3-linux.AppImage](https://github.com/TheMax98000/gitsquid-releases/releases/download/v1.7.3/GitSquid-1.7.3-linux.AppImage) |
