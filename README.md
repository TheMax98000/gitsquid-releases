...
|----------|----|----------|
| **macOS** | Apple Silicon (arm64) — Intel via Rosetta | [GitSquid_2.5.1_aarch64.app.tar.gz](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.5.1/GitSquid_2.5.1_aarch64.app.tar.gz) |
| **Windows** | x64 (Intel/AMD) | [GitSquid_2.5.1_x64-setup.exe](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.5.1/GitSquid_2.5.1_x64-setup.exe) |
| **Windows** | ARM64 (Snapdragon X, Surface Pro X) | [GitSquid_2.5.1_arm64-setup.exe](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.5.1/GitSquid_2.5.1_arm64-setup.exe) |
| **Linux** | x86_64 (amd64) | [GitSquid_2.5.1_amd64.AppImage](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.5.1/GitSquid_2.5.1_amd64.AppImage) |
| **Linux** | ARM64 (aarch64 — Pi 4/5, Graviton, Asahi) | [GitSquid_2.5.1_aarch64.AppImage](https://github.com/TheMax98000/gitsquid-releases/releases/download/v2.5.1/GitSquid_2.5.1_aarch64.AppImage) |
...
2. Extract it (double-click or `tar -xzf GitSquid_2.5.1_aarch64.app.tar.gz`) and move GitSquid.app to your Applications folder
